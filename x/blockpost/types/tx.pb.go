...
func (*MsgUpdatePost) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3d623d3f0344301, []int{4}
}
...
func (*MsgUpdatePostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3d623d3f0344301, []int{5}
}
...
func (*MsgDeletePost) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3d623d3f0344301, []int{6}
}
...
func (*MsgDeletePostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3d623d3f0344301, []int{7}
}
...
func init() {
	...
	proto.RegisterType((*MsgCreatePost)(nil), "blockpost.blockpost.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "blockpost.blockpost.MsgCreatePostResponse")
	proto.RegisterType((*MsgUpdatePost)(nil), "blockpost.blockpost.MsgUpdatePost")
	proto.RegisterType((*MsgUpdatePostResponse)(nil), "blockpost.blockpost.MsgUpdatePostResponse")
	proto.RegisterType((*MsgDeletePost)(nil), "blockpost.blockpost.MsgDeletePost")
	proto.RegisterType((*MsgDeletePostResponse)(nil), "blockpost.blockpost.MsgDeletePostResponse")
}
...
var fileDescriptor_d3d623d3f0344301 = []byte{
	...
	0xce, 0x2e, 0xc8, 0x2f, 0x2e, 0xd1, 0x47, 0xb0, 0x4a, 0x2a, 0xf4, 0x0a, 0x8a, 0xf2, 0x4b, 0xf2,
	...
	0x49, 0x3b, 0x81, 0x4c, 0x08, 0x40, 0xcf, 0x62, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0,
	0x52, 0xc2, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x3a, 0x2e, 0x80, 0x11, 0xd9, 0x04, 0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blockpost.blockpost.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdatePost(ctx context.Context, in *MsgUpdatePost, opts ...grpc.CallOption) (*MsgUpdatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blockpost.blockpost.Msg/UpdatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeletePost(ctx context.Context, in *MsgDeletePost, opts ...grpc.CallOption) (*MsgDeletePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blockpost.blockpost.Msg/DeletePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blockpost.blockpost.Msg/CreatePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blockpost.blockpost.Msg/UpdatePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeletePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blockpost.blockpost.Msg/DeletePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
