...
const (
	Query_Params_FullMethodName   = "/blockpost.blockpost.Query/Params"
	Query_ShowPost_FullMethodName = "/blockpost.blockpost.Query/ShowPost"
	Query_ListPost_FullMethodName = "/blockpost.blockpost.Query/ListPost"
)
